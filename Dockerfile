...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Mrunal1911/Beast-X/master/BeastX.py
RUN wget https://raw.githubusercontent.com/Mrunal1911//Beast-X/master/requirements.txt
#Start Fumkin
